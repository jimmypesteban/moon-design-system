...
export function DocsFooter({ variant = 'compact' }: { variant?: 'full' | 'compact' }) {
  ...
  return (
    ...
    >
      ...
      >
        <img src={moonMark} alt="" width={variant === 'full' ? 28 : 22} height={variant === 'full' ? 28 : 22} style={{ flex: 'none' }} />
        <span style={{ fontWeight: 600, color: colors['mo-black'], fontSize: variant === 'full' ? 14 : 13 }}>Moon Design System</span>
      </a>
